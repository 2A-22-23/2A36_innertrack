...
<?php
       ...
       if(isset($_POST['button'])){
            ...
            echo "<br><br> INSERT INTO achat (id_article, quantite_achat, adress_achat,idUser,phone_number) VALUES ($id_article, $quantite_achat, '$adr', '$idUser','$phone')";
               $req = $con->query("INSERT INTO achat (id_article, quantite_achat, adress_achat,idUser,phone_number) VALUES ($id_article, $quantite_achat, '$adr', '$idUser','$phone')");
