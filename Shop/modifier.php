       ...
       if(isset($_POST['button'])){
           ...
           if(isset($_POST["nom_article"]) &&isset($_POST["description"]) &&isset($_POST["prix"]) &&isset($_POST["quantite"]) &&isset($_POST["marque"])){
            //requête de modification
               ...
               $req = $con->query("UPDATE article SET nom_article = '$nom_article' , description = '$description' , prix = '$prix', prix = '$quantite', marque = '$marque', filename ='$file_name' WHERE id_article = $id_article");
