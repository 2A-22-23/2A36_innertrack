...
require 'db.php';
$message = '';
if (isset ($_POST['name'])  && isset($_POST['email'])  && isset($_POST['type_assurance'])  && isset($_POST['dateEffet'])  && isset($_POST['dateExpiration']) && isset($_POST['description']) ) {
  $name = $_POST['name'];
  $email = $_POST['email'];
  ...
  $sql = 'INSERT INTO liste(name, mail, type_assurance, dateEffet, dateExpiration,description) VALUES(:name, :email, :type_assurance, :dateEffet, :dateExpiration, :description)';
  $statement = $connection->prepare($sql);
  if ($statement->execute([':name' => $name, ':email' => $email, ':type_assurance' => $type_assurance, ':dateEffet' => $dateEffet, ':dateExpiration' => $dateExpiration , ':description' => $description])) {
  ...
  $mail->SMTPAuth = true;
  $mail->Username = 'garalibechir10@gmail.com';
  $mail->Password = 'gctpxmfrmutthkgc';
  $mail->SMTPSecure = 'tls';
  $mail->Port = 587;
  $mail->setFrom('garalibechir10@gmail.com');
  $mail->addAddress('garali.bechir@esprit.tn');
  
  $mail->isHTML=true;
  // Set up email
  $mail->Subject = 'payement effectué ';
  $mail->Body = 'payement effectué avec succes';
      ...
      <form method="post">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input type="tect" name="description" id="description" class="form-control" required>
         </div>
