...
if(!isset( $_SESSION['mail'], $_SESSION['name'],$_SESSION['role'] )){
    ...
    $verifuser = $pdo -> query('SELECT * FROM user');
        ...
        foreach($userdata as $userdata2)
        {
          $i++;
        }


        $verifuser_admin = $pdo -> query('SELECT * FROM user where role=1');
        $j=0;
        $userdata_ad = $verifuser->fetchall();
        
        foreach($userdata_ad as $userdata3)
        {
          $j++;
        }
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="page-admin.php">Home</a></li>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Address</h3>
                <p>123 Street,<br>Carthage, Tunisia</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Call Us</h3>
                <p>+21696266805<br>+21626355505</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                <i class="bi bi-envelope"></i>
                <h3>Email Us</h3>
                <p>InnerTrack@gmail.com<br>contactInnerTrack@gmail.com</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
