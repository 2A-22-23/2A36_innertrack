...
<!-- Navbar End -->
   ...
   <section class="flex">
      ...
      <form action="search.php" method="POST" class="search-form">
         <input type="text" name="search_box" class="box" maxlength="100" placeholder="search for blogs"style="font-size:20px;" required>
         <button type="submit" class="fas fa-search"  style="font-size :20px;"name="search_btn"></button>
      </form>
